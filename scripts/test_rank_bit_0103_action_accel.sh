...
#SBATCH --job-name=rank_bit_accel
...
echo ""
echo "========================================="
echo "Rank Bits For action.desiredAcceleration"
echo "========================================="
echo ""
...
python op_0103/important_bits_onnx.py \
  ...
  --out op_0103/out/important_bits_0103_taylor_seq100_b2_action_accel_top500.json
