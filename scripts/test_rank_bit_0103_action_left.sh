...
python op_0103/important_bits_onnx.py \
  ...
  --per-tensor-k 0 \
  --bitset ">=5" \
  --eval-metric=action.desiredCurvature \
  --out op_0103/out/important_bits_0103_taylor_seq100_b2_action_left_top500.json
