...
from data import Comma2k19SequenceDataset
from tools.common_dataset import make_loader, normalize_data_root
...
# --------------- Data helpers ---------------
def build_loaders(data_root, train_idx, val_idx, batch_size, device, data_length=None):
    ...
    if data_length is None:
        ...
        tr = Comma2k19SequenceDataset(train_idx, data_root, data_length, 'train', use_memcache=False)
        va = Comma2k19SequenceDataset(val_idx,   data_root, data_length, 'val',   use_memcache=False)
    tr_loader = make_loader(tr, batch_size=batch_size, shuffle=True, device=device, num_workers=0)
    va_loader = make_loader(va, batch_size=1, shuffle=False, device=device, num_workers=0)
